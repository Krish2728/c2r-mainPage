...
export function TriangleFramework({ className = "" }: TriangleFrameworkProps) {
  ...
  const handleScroll = useCallback(() => {
    ...
    animationFrameRef.current = requestAnimationFrame(() => {
      ...
      const viewportCenterInSection =
        windowCenter >= sectionTop && windowCenter <= sectionBottom;
      ...
      const thresholds = isMobile
        ? [0, 0.02, 0.04, 0.06, 0.1] // T, R, I, lines, center – minimal scroll
        : [0, 0.05, 0.1, 0.2, 0.3];
      let newStage = 0;
            ...
            >
              <Card className="border border-c2r-primary sm:border-2 shadow-md sm:shadow-lg hover:shadow-xl transition-shadow p-2 sm:py-6 sm:px-6">
                <CardContent className="p-0 sm:pt-6 sm:px-6">
                  ...
                  <h3 className="font-bold text-[10px] sm:text-lg mb-0.5 sm:mb-2 leading-tight">
            ...
            <Card className="border-t-4 border-t-c2r-primary">
              <CardContent className="pt-8">
                <h3 className="text-2xl font-bold mb-6 text-center">
                  The Complete TRIANGLE Framework
                </h3>
                <div className="space-y-6 text-muted-foreground leading-relaxed">
                  <div>
                    <h4 className="font-bold text-lg text-foreground mb-2 flex items-center gap-2">
                      <span className="h-8 w-8 rounded-full bg-c2r-primary text-white flex items-center justify-center text-sm font-bold">
                        T
                      </span>
                      Targeted Futuristic Career Pathways
                    </h4>
                    <p className="ml-10">
                      We focus on emerging industries and future-ready skills,
                      ensuring students are prepared for tomorrow's
                      opportunities, not yesterday's jobs. Our career guidance
                  ...
                  <div>
                    <h4 className="font-bold text-lg text-foreground mb-2 flex items-center gap-2">
                      <span className="h-8 w-8 rounded-full bg-c2r-secondary text-white flex items-center justify-center text-sm font-bold">
                        R
                      </span>
                      Robust Mentor Network
                    </h4>
                    <p className="ml-10">
                      Our network of experienced professionals provides
                      personalized guidance that transforms aspirations into
                      actionable plans. Human connection is at the heart of
                      everything we do.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="ml-10">
                      We bridge the gap between educational institutions,
                      industry needs, and policy frameworks to create systemic
                      change at scale. Collaboration is key to sustainable
                      impact.
                    </p>
                  </div>
                  ...
                  <div>
                    <h4 className="font-bold text-lg text-foreground mb-2 flex items-center gap-2">
                      <span className="h-8 w-8 rounded-full bg-c2r-accent text-white flex items-center justify-center text-sm font-bold">
                        A
                      </span>
                      Accessible & Inclusive
                    </h4>
                    <p className="ml-10">
                      Our programs are designed to reach underserved
                      communities, breaking down barriers of geography,
                      language, and socioeconomic status. Everyone deserves
                      access to quality mentorship.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="ml-10">
                      We build communities, not just connections. Our platform
                      creates lasting relationships that extend beyond
                      individual mentorship sessions, fostering a culture of
                  ...
                  <div>
                    ...
                    <p className="ml-10">
                      Every interaction is purposeful, with clear milestones and
                      measurable outcomes. We help students set realistic goals
                      and provide the support needed to achieve them.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="ml-10">
                      Our ultimate goal is sustainable employment and
                      entrepreneurship. We don't just prepare students for
                      careers; we help them launch and thrive in them.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="ml-10">
                      Technology enables us, but empathy guides us. We
                      understand that career journeys are deeply personal, and
                      we approach each student with compassion and respect.
                    </p>
                  </div>
                </div>
              </CardContent>
