  ...
  return (
    <section className="py-16 md:py-20 bg-background">
      <div className="container">
        <motion.div
          className="relative mx-auto max-w-5xl overflow-hidden rounded-2xl c2r-gradient-section px-6 py-14 md:px-12 md:py-20 text-center shadow-xl"
        ...
        >
          ...
          <div className="relative z-10 mx-auto max-w-2xl">
            <h2 className="c2r-heading-dark mb-5">
              You Know What Are Your Strengths. That&apos;s Enough to Start.
            </h2>
            <p className="c2r-prose-on-dark mb-8">
