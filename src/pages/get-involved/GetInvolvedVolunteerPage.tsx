...
import { Users, Clock, BookOpen, Sparkles, Award, ArrowRight } from 'lucide-react';
        ...
        <div className="container relative z-10 py-20">
          <ScrollReveal direction="fade">
            <div className="mx-auto max-w-3xl text-center text-white">
              <h1 className="mb-6 text-5xl font-bold md:text-6xl">Become a Mentor Volunteer</h1>
            ...
            <ScrollReveal delay={100}>
              <div className="grid gap-6 sm:grid-cols-2">
                {benefits.map((item, index) => (
                  <Card key={index} className="border-l-4 border-l-c2r-accent">
