...
const steps = [
  {
    num: '1',
    title: 'Align',
    content: 'Share your entry-level hiring needs, role requirements, and future workforce plans. We assess whether an existing C2R program fits your needs, or co-create a custom mentorship + skill readiness pathway aligned to your roles.',
  },
  {
    num: '2',
    title: 'Equip',
    content: 'Equip learners during the program. Culture sessions, talks, mock interviews. Early exposure to your workplace expectations. Build familiarity and confidence on both sides. This reduces hiring friction and improves candidate–role fit.',
  },
  {
    num: '3',
    title: 'Integrate',
    content: 'Interview and onboard pre-mentored, job-ready candidates. Candidates are prepared for real-world expectations. Post-placement mentoring improves retention. C2R supports tracking and feedback.',
  },
];
        ...
        <div className="container relative z-10 py-20">
          <ScrollReveal direction="fade">
            <div className="mx-auto max-w-3xl text-center text-white">
              <h1 className="mb-6 text-5xl font-bold md:text-6xl">How It Works</h1>
