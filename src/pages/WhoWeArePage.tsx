            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-6">
                ...
                <p className="c2r-prose">
                  ...
                  pathways—creating a holistic ecosystem that nurtures talent
                    ...
                    <div className="flex-1 space-y-6">
                      <div className="space-y-6">
                        <p className="c2r-prose">
                          ...
                          ambition, but because they lacked access to the right
                        ...
                        <p className="c2r-prose">
                          ...
                          show her the path forward. That moment sparked a
                          question:{" "}
                          <span className="font-bold text-foreground italic">
                            "What if we could connect every aspiring
                        ...
                        <p className="c2r-prose">
                          ...
                          platform serving thousands of individuals across
                        ...
                        <p className="c2r-prose">
                          ...
                          guidance, and the potential that exists in every
                          individual when given the right support.
                        </p>
                      </div>
                    </div>
                  </div>
