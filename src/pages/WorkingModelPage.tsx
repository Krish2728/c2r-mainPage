            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-6">
                <p className="c2r-prose-emphasis">
                  ...
                  young people face a fundamental challenge:{" "}
                ...
                <p className="c2r-prose">
                  ...
                  particularly acute in underserved communities, where access to
                ...
                <p className="c2r-prose">
                  ...
                  issue—it's a question of social equity and national potential.
                </p>
                ...
                <CardContent className="pt-8">
                  <div className="space-y-6">
                    ...
                    <p className="c2r-prose">
                      ...
                      development and clear pathways to opportunity, they don't
                    ...
                    <p className="c2r-prose">
                      ...
                      the confidence that comes from knowing someone believes in
                      your potential.
                    </p>
                  </div>
                </CardContent>
              ...
              <div className="flex items-start gap-4 p-6 bg-gradient-to-r from-c2r-primary/10 to-c2r-secondary/10 rounded-lg border-l-4 border-l-c2r-accent">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    professionals who have actually walked the path they aspire
                    to take. This creates authentic connections, realistic
                    expectations, and actionable insights that generic advice
                ...
                <Card className="h-full border-t-4 border-t-c2r-primary transform transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                  <CardContent className="pt-8 text-center">
                    ...
                    <div className="pt-6 border-t border-border">
                      <p className="text-sm font-semibold text-c2r-primary mb-2">
                        Impact:
                      </p>
                ...
                <CardContent className="pt-8 pb-8">
                  <div className="text-center space-y-4">
                    ...
                    <p className="c2r-prose">
                      ...
                      pathway from aspiration to achievement—addressing not just
                      what students need to learn, but how they learn it and
                      where they apply it.
                    </p>
                  </div>
                </CardContent>
                ...
                <CardContent className="pt-8">
                  ...
                  <ul className="space-y-3 text-muted-foreground">
                    ...
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="h-5 w-5 text-c2r-primary flex-shrink-0 mt-0.5" />
                      <span>
                        Access to internships, jobs, and entrepreneurship
                        support
                      </span>
                    </li>
                  </ul>
