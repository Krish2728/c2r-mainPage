              ...
              return (
                <div key={index} id={PROGRAM_SLUGS[index] ?? undefined}>
                  ...
                  <div className="max-w-6xl mx-auto space-y-12">
                    ...
                    {/* Program Details - image wrapped by text */}
                    <ScrollReveal delay={200} direction="up">
                      <Card className="border-t-4 border-t-c2r-primary overflow-hidden">
                        <CardContent className="pt-6">
                          <div className="overflow-hidden">
                            <div
                              className={`relative overflow-hidden rounded-lg shadow-xl w-full sm:w-72 sm:max-w-[40%] aspect-[4/3] mb-4 sm:mb-0 ${index % 2 === 0 ? "sm:float-left sm:mr-6" : "sm:float-right sm:ml-6"}`}
                            >
                              <img
                                src={program.image}
                                alt={program.title}
                                ...
                                <div className="md:text-right md:pl-8">
                                  ...
                                  <ul className="space-y-2 md:flex md:flex-col md:items-end">
                                    {program.outcomes.map((outcome, i) => (
                                      <li
                                        key={i}
                                        className="flex items-start gap-2 text-sm sm:text-base text-muted-foreground md:flex-row-reverse md:gap-2"
                                      >
