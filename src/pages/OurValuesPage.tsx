  ...
  const values = [
    {
      ...
      story:
        "Every student we work with has a unique story. We listen, understand, and tailor our support to meet individual needs, ensuring no one is left behind.",
    },
    {
      icon: Users,
      ...
      story:
        "From volunteer mentors dedicating their time to corporate partners providing resources, our community is the backbone of our impact.",
    },
    {
      icon: Target,
      ...
      story:
        "Every mentorship session, every skill learned, and every job secured represents a life transformed and a community uplifted.",
    },
    {
      icon: Lightbulb,
      title: "Innovation & Adaptability",
      description:
        "We embrace technology and innovative approaches to scale our impact while remaining flexible to the evolving needs of our beneficiaries.",
      story:
        "From AI-powered mentor matching to adaptive learning pathways, we continuously innovate to serve our students better.",
    },
    {
      icon: Shield,
      ...
      story:
        "Our stakeholders trust us because we maintain open communication, share our challenges, and celebrate our successes together.",
    },
    {
      icon: Sparkles,
      ...
      story:
        "From comprehensive mentor training to structured curricula, we ensure every aspect of our programs meets the highest standards.",
    },
  ];
