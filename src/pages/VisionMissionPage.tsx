            ...
            <ScrollReveal delay={400}>
              <Card className="h-full border-l-4 border-l-c2r-accent transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
                <CardContent className="pt-8">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Providing resources, mentorship, and pathways for
                    individuals to create their own opportunities through
                ...
                <CardContent className="pt-12 pb-12">
                  ...
                  <div className="prose prose-lg max-w-none text-center space-y-6">
                    <p className="text-xl text-muted-foreground leading-relaxed">
                      ...
                      practical skill development, and supporting
                      entrepreneurial ventures, we're not just changing
                      individual lives—we're transforming entire communities and
          ...
          <div className="mt-16 max-w-4xl mx-auto">
            <ScrollReveal delay={200}>
              <div className="space-y-6">
                <Card className="overflow-hidden border-none bg-gradient-to-br from-c2r-primary/20 via-c2r-primary/10 to-transparent shadow-md">
                  <CardContent className="p-6 flex gap-6 items-start">
                    <div className="flex-shrink-0 w-12 h-12 rounded-full bg-c2r-primary/20 flex items-center justify-center ring-2 ring-c2r-primary/30">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground leading-relaxed">
                        Every person we serve gains not just skills or
                        connections, but confidence, clarity, and the belief
                        that their dreams are achievable. We empower individuals
                        to take control of their career journeys and unlock
                ...
                <Card className="overflow-hidden border-none bg-gradient-to-br from-c2r-secondary/20 via-c2r-secondary/10 to-transparent shadow-md">
                  <CardContent className="p-6 flex gap-6 items-start">
                    <div className="flex-shrink-0 w-12 h-12 rounded-full bg-c2r-secondary/20 flex items-center justify-center ring-2 ring-c2r-secondary/30">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground leading-relaxed">
                        When individuals succeed, communities thrive. Our work
                        creates ripple effects—mentored students become future
                        mentors, skilled professionals contribute to local
                        economies, and entrepreneurs create opportunities for
                        others.
                      </p>
                    </div>
                  </CardContent>
                ...
                <Card className="overflow-hidden border-none bg-gradient-to-br from-c2r-accent/20 via-c2r-accent/10 to-transparent shadow-md">
                  <CardContent className="p-6 flex gap-6 items-start">
                    <div className="flex-shrink-0 w-12 h-12 rounded-full bg-c2r-accent/20 flex items-center justify-center ring-2 ring-c2r-accent/30">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground leading-relaxed">
                        We're working toward a future where success is
                        determined by talent and effort, not by circumstances of
                        birth. A future where every individual has the support
                        they need to contribute their unique gifts to society.
                      </p>
                    </div>
                  </CardContent>
                </Card>
